...
export const NotFound = () => {
  return (
    <div className="flex justify-center items-center mt-24 gap-8  m-10 py-10 rounded-xl shadow-2xl">
      <img
      ...
      <div className="text-center m-4">
        <h1 className="text-5xl text-center text-indigo-950">Error 404</h1>
        <Link to="/">
